...
/**
 * Request DTO for adding card payment information
 *
 * @author lh
 */
@Data
public class CrmAddCardPaymentDTO {
    ...
    /**
     * Card expiry date required 格式 yyyy-MM
     * Example: Expiry Date
     */
     ...
     * >= 0 characters <= 200 characters
     */
    @Size(min = 0, max = 200, message = "city size must be between {min} and {max}")
    private String city;
