 ...
 */
@Data
public class IamCreateSubUserAdapterDTO {
    /**
     * required
     * Company code
     * Example: unin0001
     ...
     */
    private String eventCode = CommonConstants.StrConstants.EVENT_CODE_CREATE_SUB;
    
    /**
     * App code for the application
     * Example: APPCODE
     */
    private String appcode = CommonConstants.StrConstants.SELF_APP_CODE;
} 