 ...
 * 面试报告表实体类
 * 
 * 映射PostgreSQL数据库中的candidates.application_interview_reports表，
 * 用于存储AI面试系统生成的面试报告和评分数据。
 * 
 * @author liyunlong
 * @version 1.0
 * @since 2025-09-28
 */
@Data
@TableName("candidates.application_interview_reports")
public class ApplicationInterviewReportsEntity {
